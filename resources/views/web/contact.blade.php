        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="contact-info-box">
                    ...
                    <h3>Mail Here</h3>
                    <p><a href="#"><span class="__cf_email__" data-cfemail="69080d040007291a1d081b1d19470a0604">[email&#160;protected]</span></a></p>
                    <p><a href="#"><span class="__cf_email__" data-cfemail="94fdfaf2fbd4e7e0f5e6e0e4baf7fbf9">[email&#160;protected]</span></a></p>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row h-100 justify-content-center align-items-center">
            <div class="col-lg-6 col-md-12">
                <img src="{{ asset('web/assets/img/1.png')}}" alt="image">
            </div>
